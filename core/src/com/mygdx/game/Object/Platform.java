...
public class Platform implements Poolable {
	...
	public static final float DRAW_WIDTH_NORMAL = PlataformPiece.DRAW_WIDTH_NORMAL / 2f;
	public static final float DRAW_HEIGTH_NORMAL = PlataformPiece.DRAW_HEIGTH_NORMAL;
	public static final float WIDTH_NORMAL = PlataformPiece.WIDTH_NORMAL / 2f;
	public static final float HEIGTH_NORMAL = PlataformPiece.HEIGTH_NORMAL;
