...
public class Coin implements Poolable {
	...
	public static void createMoneda(World worldBox, Array<Coin> arrMonedas, float y) {
	...
	private static void createMoneda(World worldBox, Array<Coin> arrMonedas, float x, float y) {
		Coin oMoneda = Pools.obtain(Coin.class);
		oMoneda.init(x, y);
